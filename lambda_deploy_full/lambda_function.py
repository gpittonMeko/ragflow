...
INSTANCES_CONFIG = {
    'SGAI-Production': {
        ...
        'host': '13.49.16.179',
        'user': 'ubuntu',
        # Policy: resta SPENTA salvo wake esplicito da SGAI Home (force_start su questa API).
        # Nessun avvio da fascia oraria. Spegnimento: auto_shutdown_monitor (60 min min dopo wake
        # file Lambda, poi 30 min idle dopo ultima chat; avvio console senza file → finestra corta).
        'on_demand': True,
        'ora_inizio': 8,
        'ora_fine': 21,
...
def process_instance(instance_name, config, now_roma, force, key_obj):
    ...
    try:
        ...
        # ---------- EC2 accesa ----------
            ...
            # On-demand: non spegnere da Lambda per "fuori orario" (solo force_stop o monitor su EC2)
